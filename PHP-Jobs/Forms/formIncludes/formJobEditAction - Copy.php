...
switch ($confModel->jobhtmltag){
    ...
    case "textarea":
        ...
        echo "<td>".$limg."<textarea id='".$key."' name='".$key."' ".$confModel->jobhtmltype." >".$val."</textarea>".$img."</td>";
        break;
    case "list":
        if ( $fileKey == $key ) {
            $hdLabel = getLabel("current",$locale);
    ...
    case "select":
        ...
        switch ($confModel->selvaltype){
            ...
            echo "<td ><select id='".$key.$multi."' name='".$key.$multi."' ".$confModel->jobhtmltype." onchange=\"javascript:".$confModel->jscript.";\" >";
    ...
    case "label":
        ...
        echo "<td nowrap valign='top'>".$hdrLabel."</td>";
        echo "<td><label>".$prefix.$val."</label></td>";
        break;
    Default:
        $v = $val;
        ...
        switch ($confModel->jobhtmltype) {
            ...
            Default:
                ...
                echo "<td nowrap valign='top'>".$hdrLabel."</td>";
                echo "<td>$limg $prefix<input type=".$confModel->jobhtmltype." id='".$key."' name='".$key."' value='$v'/>".$img."</td>";
            }
        }
        if ( $enc_password && $key == $enc_key ) {
