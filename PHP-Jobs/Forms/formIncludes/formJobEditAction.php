    ...
    case "textarea":
        if ( $fileKey == $key ) {
            ...
            if ( $val != "" ) {
                ...
                echo "<td><a href='download.php?id=".$id."'>".$val."</a>&nbsp;&nbsp;<a href='delete.php?f=".$applicantId."_".$val."&id=".$id."'>".$hdLabel."</a></td></tr><tr>";
            } else {
                echo "<td>&nbsp;</td></tr><tr>";
            }
        }
        ...
        echo "<td nowrap valign='top'>".$hdrLabel."</td>";
                echo "<td valign='top'>".$limg."<textarea id='".$key."' name='".$key."' ".$confModel->jobhtmltype." >".$val."</textarea>".$img."</td>";
        break;
    case "list":
        if ( $fileKey == $key ) {
            $hdLabel = getLabel("current",$locale);
    ...
    case "select":
        ...
        switch ($confModel->selvaltype){
            ...
            case "var":
                ...
                break;
            case "sql":
                $optList = getSqlOptList($confModel->conf_value,$confModel->jobhtmltype);
                break;
            case "dbFunctions":
                if ( ! strpos($confModel->jobhtmltype,"multi") === false )
                $multi="[]";
            ...
            if ( $confModel->jobhtmltype == "pre" && $confModel->phpCode != "" ) {
                ...
                eval ($confCode);
                        ...
                        echo "<td  valign='top'><select id='".$key.$multi."' name='".$key.$multi."' ".$confModel->jobhtmltype." onchange=\"javascript:".$confModel->jscript.";\" >";
        ...
        switch ($confModel->jobhtmltype) {
            ...
            case "checkbox":
                ...
                Default:
                        ...
                        eval($confModel->phpCode);
                        if ( $fileKey == $key ) {
                                $langPrefix = getLabel("current",$locale);
                                echo "<td nowrap valign='top'>".$langPrefix." ".$hdrLabel."</td>";
                                if ( $val != "" ) {
                                        $hdLabel = getLabel("delete",$locale);
                                        echo "<td><a href='download.php?id=".$id."'>".$val."</a>&nbsp;&nbsp;<a href='delete.php?f=".$applicantId."_".$val."&id=".$id."'>".$hdLabel."</a></td></tr><tr>";
                                } else {
                        ...
                        echo "<td nowrap valign='top'>".$hdrLabel."</td>";
                        echo "<td valign='top'>$limg $prefix<input type=".$confModel->jobhtmltype." id='".$key."' name='".$key."' value='$v'/>".$img."</td>";
            }
        }
        if ( $enc_password && $key == $enc_key ) {
            ...
            echo "<tr>";
                        echo "<td valign='top'>".$hdrLabel."</td>";
                        echo "<td valign='top'><input type='".$type."' id='".$confirm_password."' name='".$confirm_password."' value=''/></td>";
            echo "</tr>";
        }
        ?>
