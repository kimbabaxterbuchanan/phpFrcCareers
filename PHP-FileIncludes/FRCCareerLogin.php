...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        ?>
        <form id="loginForm" name="loginForm" method="post" action="PHP-FileIncludes/loginForm.php">
            ...
            <table width="726" border="0" align="Left" valign="Top" cellpadding="0" cellspacing="0">
                   <tr>
                       <td colspan="2" align="center">
                               <h1>Career Site Log-In</h1>
                       </td>
                   </tr>
                    <tr>
                    <?php $hdrLabel = getLabel("registerAndSubmitResume",$locale); ?>
                        <td align="right">&nbsp;</td><td align="right"><a href="FRCCareer.php?section=action&sub_section=<?php echo $sub_section?>&table=applicant&edit=edit&formAction=new&careerIds=<?php echo $careerIds?>"><?php echo $hdrLabel?></a></td>
                    </tr>
                     <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                   <tr>
                    ...
                    <?php $hdrLabel = getLabel("loginForgotPassword",$locale); ?>
                        <a style="color:#000000" href="FRCCareer.php?section=ForgotPassword"><?php echo $hdrLabel?></a>
                        </td>
                    </tr>
            </table>
        </form>
