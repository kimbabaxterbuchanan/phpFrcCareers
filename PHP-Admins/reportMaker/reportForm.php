...
$omittables = array();
$omittables[]="configuration";
$omittables[]="email";
$omittables[]="forwarder";
$omittables[]="language";
$omittables[]="notification";
$omittables[]="tablelink";
$omittables[]="report";
$omittables[]="sellistsql";
$omittables[]="country";
$omittables[]="state";
...
<html>
    ...
    <body>
     ...
     <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
   <?php $hdrLabel = getLabel("reportHdr",$locale); ?>
     <?php echo $hdrLabel?><br>
        <hr>
        <!--a href="lib/capabilites.html">Capabilites</a>
        |<a href="lib/references.html">References</a>|-->
        <?php $hdrLabel = getLabel("instructions",$locale); ?>
        <a href="lib/instruct.html"><?php echo $hdrLabel?></a>
        <?php
        echo "<hr>";
//        set_error_handler("CustomErrorHandler");
//        if ( isset($database) && $database != "" )
//            echo "Database ".strtoupper($database)." will be used to generate the Report.<BR>";
        ...
        ?>
            ...
            echo "<form method=\"post\" action=\"PHP-Admins/reportMaker/reportForm.php\"><select size=5 name=\"database\">\n";
            $i = 0;
            ...
            echo "<input type=hidden name=applicant value='$applicant'>\n";
        ...
        if ($btnSubmit == "SelectTables" || ( $btnSubmit == "Create" && $database != "" ) )
        {
            ...
            echo "<form method=\"post\" action=\"PHP-Admins/reportMaker/reportForm.php\"><select multiple size=5 name=\"table[]\">\n";
            $i = 0;
            while ($i < mysql_num_rows ($result))
            {
        ...
        if ($btnSubmit == "SelectFields")
        {
            ...
            echo "</tr>";
            echo "<form method=\"post\" action=\"PHP-Admins/reportMaker/reportForm.php\">\n";
            echo "<tr>";
            for($j = 0; $j<$cnt; $j++)
            {
                $tabz = $xy[$j];
...
//            $xy = matchset($fields);
        ...
        if ($btnSubmit == "Save")
        {
            ...
            $reportModel->reportsql = $cquery;
            $stat = $reportDAO->saveUpdate($reportModel, 'report');
        ...
        if ($btnTable2 == "PickQuery")
        {
            ...
            echo "<form method=\"post\" action=\"PHP-Admins/reportMaker/reportForm.php\"><select  name=\"loadas\">\n";
            //     $dirname = "sqldocs";
            $dh = opendir($dirname);
        ...
        if ($btnSubmit == "ExecQuery")
        {
            ...
            echo "<form id=\"rptForm\" name=\"rptForm\" method=\"post\" action=\"PHP-Admins/reportMaker/reportForm.php\" >";
			...
			echo "<div  style='height:500; width:750; overflow:auto;'>";
        ...
        <?php
            ...
            echo "<input type='submit' name='cancel' id='cancel' value='".$hdrLabel."' />";
            if ( ! $runQry ) {
        ...
        if (empty($btnSubmit) || $btnSubmit == "Start Over" )
        {
            ?>
                ...
                <form id="rptForm" name="rptForm" method="post" action="PHP-Admins/reportMaker/reportForm.php" >
                    <input type="hidden" id='database' name='database' value='<?php echo $db_DATABASE?>' />
                    <table border=1 cellpadding=3>
                        <?php $hdr = getLabel('createquerylabel',$locale); ?>
                        <tr><th><font color =green><?php echo $hdr?></font></th>
                        <?php $hdr = getLabel('runexistingquerylabel', $locale); ?>
                        <th><font color =green><?php echo $hdr?></font></th></tr>
                        <?php $hdr = getLabel('reportname',$locale); ?>
                        <tr><td><?php echo $hdr?>: </td><td><input type="text" size="40" name="reportname" id="reportname" value="<?php echo $name?>"></td></tr>
                        <?php $hdr = getLabel('reportdescription',$locale); ?>
                        <tr><td><?php echo $hdr?>: </td><td><textarea cols=60 rows=5 name="reportdescription" id="reportdescription"><?php echo $description?></textarea></td></tr>
                        <?php $hdr = getLabel('reporttitle',$locale); ?>
                        <tr><td><?php echo $hdr?>: </td><td><input type="text" size="40" name="reporttitle" id="reporttitle" value="<?php echo $title?>"></td></tr>
                        <tr>
                            <td colspan=2 align=center><input type="submit" name="btnSubmit" id="btnSubmit" value="Create">
                            <input type="submit" name="btnSubmit" id="btnSubmit" value="Run"></td>
                        </tr>
                        <tr>
                            <?php $hdrLabel = getLabel("cancel",$locale); ?>
                            <td colspan='10' align='center'><input type='submit' name='cancel' id='cancel' value='<?php echo $hdrLabel?>' /></td>
                        </tr>
                    </table>
