...
function refreshDocApplicantInfo(formType) {
...
//    var applicantId = phpObj.options[selIdx].value;
//    var ref = document.getElementById("refresh");
//    ref.value="refresh";
        obj = new getObj("postForm");
        obj.value="";
    document.forms[formType+"Form"].submit();
//    document.location.href="FRCForm.php?formType="+formType+"&applicantId="+applicantId+"&status="+status;
