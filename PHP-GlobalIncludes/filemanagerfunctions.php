...
function upload_form(){
    global $_FILES,$dir_atual,$dir_dest,$fechar,$quota_mb,$path_info,$upload_num;
    $num_uploads = 5;
    html_header();
...
function chmod_form(){
    ...
    $aux = "
        ...
        {
        var applicants = new Array(\"owner\", \"group\", \"other\");
        ...
        var field4 = applicant + \"4\";
        var field2 = applicant + \"2\";
        var field1 = applicant + \"1\";
        var symbolic = \"sym_\" + applicant;
        var number = 0;
        var sym_string = \"\";
        var sticky = \"0\";
        var sticky_sym = \" \";
...
function server_info(){
    ...
    $ignore_applicant_abort = ignore_applicant_abort();
    ...
    echo "<tr><td>ignore_applicant_abort<td>".($ignore_applicant_abort?"on":"off")."<td>on<td>".(ignore_applicant_abort()?"on":"off");
            ...
            while ($file = readdir($opdir)) {
                    ...
                    if ( $loadFile == true ) {
                            ...
                            if ($islinux && $resolveIDs){
                                    ...
                                    $entry_list[$entry_count]["u"] = getapplicant(fileowner($dir_atual.$file));
